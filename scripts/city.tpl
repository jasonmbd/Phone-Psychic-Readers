...
{ "@context": "https://schema.org", "@type": "Service", "serviceType": "Phone Psychic Reading", "name": "Phone Psychic Reading in {{CITY}}, {{STATE}}", "url": "https://www.phonepsychicreaders.com/{{SLUG}}.html", "image": "https://www.phonepsychicreaders.com/assets/img/phone-psychic-readers-logo.png", "description": "Live phone psychics serving {{CITY}}, {{STATE}} 24/7 - psychic, tarot, astrology, and numerology readings from $1 per minute. Delivered by phone from the Burbank, CA office; no in-person visits in {{CITY}}.", "provider": { "@type": "LocalBusiness", "@id": "https://www.phonepsychicreaders.com/#business", "name": "Phone Psychic Readers", "url": "https://www.phonepsychicreaders.com/", "telephone": "+1-888-920-6662" }, "areaServed": { "@type": "City", "name": "{{CITY}}", "containedInPlace": { "@type": "AdministrativeArea", "name": "{{COUNTY}}" } }, "offers": { "@type": "Offer", "price": "1.00", "priceCurrency": "USD", "description": "Introductory rate $1 per minute for first-time callers" }, "availableChannel": { "@type": "ServiceChannel", "servicePhone": "+1-888-920-6662", "availableLanguage": "English" }, "hoursAvailable": { "@type": "OpeningHoursSpecification", "dayOfWeek": ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"], "opens": "00:00", "closes": "23:59" } }
</script>
<script type="application/ld+json">
...
<main id="main">
  ...
  <nav class="breadcrumb" aria-label="Breadcrumb">
    <div class="container">
      <a href="index.html">Home</a> &rsaquo; <a href="locations.html">Locations</a> &rsaquo; <span>{{CITY}}, {{STATE}}</span>
    </div>
  </nav>
    ...
    <div class="container">
      ...
      <div class="intro-grid">
        <div>
          ...
          <p>Most-requested in {{CITY}}: <a href="psychic-love-readings-by-phone.html">Love Psychic Reading</a> &middot; <a href="phone-tarot-reading.html">Tarot Card Reading</a> &middot; <a href="psychic-reading.html">Psychic Reading</a></p>
  ...
  <section>
    <div class="container">
      ...
      <div class="category">
        <div>
          <h2><a href="psychic.html">{{CITY}} Psychic</a></h2>
          ...
          <a class="cat-all-link" href="psychic.html">See all Psychic services &rarr;</a>
        </div>
      ...
      <div class="category">
        <div>
          <h2><a href="astrologer.html">{{CITY}} Astrologer</a></h2>
          ...
          <a class="cat-all-link" href="astrologer.html">See all Astrologer services &rarr;</a>
        </div>
      ...
      <div class="category">
        <div>
          <h2><a href="numerologist.html">{{CITY}} Numerologist</a></h2>
          ...
          <a class="cat-all-link" href="numerologist.html">See all Numerologist services &rarr;</a>
        </div>
      ...
      <div class="category">
        <div>
          <h2><a href="fortune-telling-services.html">{{CITY}} Fortune Telling Services</a></h2>
          ...
          <a class="cat-all-link" href="fortune-telling-services.html">See all Fortune Telling Services &rarr;</a>
        </div>
